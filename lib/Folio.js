...
var ObjectDecorator = require('./decorators/ObjectDecorator');
var SendObjectDecoration = require('./decorators/response-decorations/SendObjectDecoration');
...
function Folio() {
    ...
    this._requestDecorator = new ObjectDecorator();
    this._responseDecorator = new ObjectDecorator();
    this._requestHandler = new RequestHandler(this._routeManager, this._routeMiddlewareManager, this._routeHandlerManager, this._requestDecorator, this._responseDecorator);
    ...
    this._sendObjectDecoration = new SendObjectDecoration();
    this._responseDecorator.addDecoration(this._sendObjectDecoration);
}
