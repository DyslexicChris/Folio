...
RouteMiddlewareManager.prototype.addMiddlewareForMethod = function (method, middleware) {
    ...
    this._validateMiddleware(middleware);
    this._methodMiddleware[method] || (this._methodMiddleware[method] = []);
    this._methodMiddleware[method].push(middleware);
};
...
RouteMiddlewareManager.prototype.addGlobalMiddleware = function (middleware) {
    ...
    this._validateMiddleware(middleware);
    this._methodMiddleware.global || (this._methodMiddleware.global = []);
    this._methodMiddleware.global.push(middleware);
